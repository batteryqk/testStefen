    ...
    <section>
        ...
        <div
            ...
            <div class="glass-card rounded-2xl p-6 md:col-span-5">
                <form action="{{ route('pm.product.update', encrypt($product->id)) }}"  method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                        ...
                        <div class="space-y-2">
                            ...
                            <label class="input flex items-center gap-2">
                                <input type="text" placeholder="Name" id="name" value="{{ $product->name }}" name="name"
                                    class="flex-1" />
                            </label>
                        ...
                        <div class="space-y-2">
                            ...
                            <label class="input flex items-center gap-2">
                                ...
                                <input type="text" name="slug" id="slug" value="{{ $product->slug }}" class="flex-1" />
                            </label>
                        ...
                        <div class="space-y-2">
                            ...
                            <label class="input flex items-center gap-2">
                                ...
                                <input type="text" name="stock_no"  value="{{ $product->stock_no }}" class="flex-1" />
                            </label>
