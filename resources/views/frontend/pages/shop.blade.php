...
<div class="container mx-auto px-4 sm:px-6 lg:px-12 mt-10 mb-16">
  ...
  <div class="absolute inset-0 bg-gradient-to-t from-black via-transparent to-transparent opacity-0 group-hover:opacity-20 transition-opacity duration-500"></div>
      ...
      <div class="p-5 sm:p-7">
        ...
        <div class="flex items-center mb-4">
          <div class="flex space-x-1">
            <svg class="w-5 h-5 text-yellow-400 fill-current" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><polygon points="10,1 12.59,7.36 19.51,7.36 13.97,11.63 16.56,17.99 10,13.72 3.44,17.99 6.03,11.63 0.49,7.36 7.41,7.36"/></svg>
            <svg class="w-5 h-5 text-yellow-400 fill-current" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><polygon points="10,1 12.59,7.36 19.51,7.36 13.97,11.63 16.56,17.99 10,13.72 3.44,17.99 6.03,11.63 0.49,7.36 7.41,7.36"/></svg>
            <svg class="w-5 h-5 text-yellow-400 fill-current" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><polygon points="10,1 12.59,7.36 19.51,7.36 13.97,11.63 16.56,17.99 10,13.72 3.44,17.99 6.03,11.63 0.49,7.36 7.41,7.36"/></svg>
            <svg class="w-5 h-5 text-yellow-400 fill-current" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><polygon points="10,1 12.59,7.36 19.51,7.36 13.97,11.63 16.56,17.99 10,13.72 3.44,17.99 6.03,11.63 0.49,7.36 7.41,7.36"/></svg>
            <svg class="w-5 h-5 text-gray-300 fill-current" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><polygon points="10,1 12.59,7.36 19.51,7.36 13.97,11.63 16.56,17.99 10,13.72 3.44,17.99 6.03,11.63 0.49,7.36 7.41,7.36"/></svg>
          </div>
    ...
    <!-- Repeat this block 3 more times for Product 2, 3, 4 -->
    <!-- Copy-paste the above product block 3 times and update if needed -->
...
<div class="bg-white rounded-3xl overflow-hidden relative group px-2">
  ...
  <!-- Previous Button -->
  <a href="#" id="prevBtn" class="w-12 h-12 bg-red-600 text-white font-bold text-lg flex items-center justify-center rounded-lg t hover:bg-red-700 transition cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed" aria-label="Previous">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 25 25" class="w-6 h-6 font-bold"><path style="fill:#fff" d="M24 12.001H2.914l5.294-5.295-.707-.707L1 12.501l6.5 6.5.707-.707-5.293-5.293H24v-1z" data-name="Left"/></svg>
  </a>

  <!-- Page 1 -->
  <a href="#" class="w-12 h-12 bg-red-600 text-white font-bold text-lg flex items-center justify-center rounded-lg hover:bg-red-700 transition">1</a>

  <!-- Page 2 -->
  <a href="#" class="w-12 h-12 bg-red-600 text-white font-bold text-lg flex items-center justify-center rounded-lg hover:bg-red-700 transition">2</a>

  <!-- Next Button -->
 <a href="#" id="nextBtn" class="w-12 h-12 bg-red-600 text-white font-bold text-lg flex items-center justify-center rounded-lg hover:bg-red-700 transition cursor-pointer" aria-label="Next">
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 25 25" class="h-6 w-6 font-bold">
